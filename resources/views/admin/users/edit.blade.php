        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::text('name', old('name', $user->name), ['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::email('email', old('email', $user->email), ['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
                    <p class="help-block"></p>
                    @if($errors->has('email'))
                        <p class="help-block">
                            {{ $errors->first('email') }}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('team_id[]', $teams, old('team_id[]', $user->teams->pluck('id')), ['class' => 'form-control select2', 'multiple']) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('permissions[]', trans('quickadmin.users.fields.permissions').'', ['class' => 'control-label']) !!}
                    {!! Form::select('permissions[]', $permissions, old('permissions[]', $user->permissions->pluck('id')), ['class' => 'form-control select2', 'multiple']) !!}
                    <p class="help-block"></p>
