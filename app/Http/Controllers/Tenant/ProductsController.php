...
class ProductsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('tenants.products.index', compact('products'));
    }
    ...
    public function create()
    {
        ...
        return view('tenants.products.create', compact('created_by_teams', 'created_by_ids'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('tenants.products.edit', compact('product', 'created_by_teams', 'created_by_ids'));
    }
